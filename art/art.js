...
function generateArtIdea(complexity, category) {
    ...
    var animals = ["dog", "cat", "tiger", "kitten", "puppy", "bat", "monkey", "panda", "frog", "turtle", "dinosaur", "parrot", "crocodile", "fennec fox", "furret", "mouse", "wolf", "lizard", "hedgehog", "fox", "rabbit", "bunny", "sloth", "koala", "raccoon", "otter", "seal", "ferret", "puppy", "slime", "goblin"];
    if (char[0] == "animal") char[0] = animals[MathRInt(0, animals.length - 1)] + (MathRInt(0, 2) == 2 ? "(or a creature that looks like it)" : "");

    var personalityTraits = ["confident", "nervous", "scared", "angry", "tired", "careless", "wacky", "derpy", "adventurous", "creepy", "friendly", "shy", "stupid", "athletic", "colorful", "brave", "insane", "strict", "dirty", "clean", "messy", "selfish", "greedy", "sad"]; // personality or mood
    var personalityTrait = personalityTraits[MathRInt(0, personalityTraits.length - 1)];
        var traits1 = ["loves balloons", "loves camping", "hates balloons", "likes to bully others", "loves danger", "loves flowers", "hates outdoors", "likes to draw", "is a poet", "loves to fly", "is scared of heights", "loves the life of the countryside", "is a musician", "loves to dress fancy", "lives in the slums", "lives in the sewers", "is helpful", "is a scientist", "is a knight", "is a scientist", "is depressed", "is a clown", "likes to eat a lot", "knows dark magic", "is a theatre actor", "loves to build things", "likes to destroy things", "reads many books", "works as a balloon vendor", "holds a gun", "loves to daydream", "is a night person", "is a pirate", "loves fishing", "holds a balloon sword"];
    var trait1 = traits1[MathRInt(0, traits1.length - 1)];
        var traits2 = ["is a great fighter", "is a nerd", "is an archer", "always gets in trouble", "has rich parents", "is an orphan", "loves to sing", "loves to play with dolls", "loves to play with cards", "is a great swimmer", "eats only vegetables", "is a dragon slayer", "is very dramatic", "loves to dress up in costumes", "loves bowties", "dislikes girls", "fights with swords", "fights with magic", "loves to explore dungeons", "is a proud scout", "loves hugging everything", "loves hugging balloons", "is a friend of slimes", "has a bunny friend", "likes to smoke", "has a ghost friend", "has ghost friends", "likes explosives", "is running from a huge monster", "likes to cook", "is an inventor", "plays a violin", "plays an instrument", "plays poker"];
        var trait2 = traits2[MathRInt(0, traits2.length - 1)];

        var associatedWords = ["Red", "Blue", "Wind", "Stone", "Sit", "Lay Down", "Stand", "Run", "Pink", "Purple", "Tiny", "Village", "City", "Modern", "Sci-Fi", "Fantasy", "Magic", "Steampunk", "Flowers", "White", "Black", "Yellow", "Green", "Slow", "Fast", "Rich", "Dark", "Light", "Heavy", "Sharp", "Round", "Colorful", "Dull", "Large", "Small", "Horror", "Adventure", "Happiness"];
