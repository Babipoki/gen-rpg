...
function generateArtIdea(complexity, category) {
    ...
    if (category == "Fanart") {
        ...
        var allSeries = [
            ...
            ["Solo Series", 3, ["Alvin (Chipmunks)", "Rex (Xenoblade)", "Nup Martini (Summon Night 3)", "Halé (Halé+Guu)", "Prince Ezran (Dragon Prince)", "Len Kagamine", "Bojji (Ousama Ranking)"]],
    ...
    while (char[1] < minComplexity || char[1] > maxComplexity) {
        ...
        var animals = ["dog", "cat", "tiger", "kitten", "puppy", "bat", "monkey", "panda", "frog", "turtle", "dinosaur", "parrot", "crocodile", "fennec fox", "furret", "mouse", "wolf", "lizard", "hedgehog", "fox", "rabbit", "bunny", "sloth", "koala", "raccoon", "otter", "seal", "ferret", "puppy", "slime", "goblin", "yordle", "skunk", "penguin", "squirrel", "duck", "hyena"];
